...
![Products and Services Part 1](https://github.com/Blaize-Egelhof/P4-Genepool/blob/main/media/media-for-readme/products-services-p1.PNG)

![Products and Services Part 2](https://github.com/Blaize-Egelhof/P4-Genepool/blob/main/media/media-for-readme/products-services-p2.PNG)
...
- #### Navigation Bar
  ...
  - The navigation bar includes various clickable links, allowing the user to easily access the pages on the site. Access is distinct between admin staff users and standard client users, with restricted access to standard client users. There is also signup, login and logout functionality which changes according to the status of the user. 
    ...
    - Staff Login:
    ![Nav Bar Staff](https://github.com/Blaize-Egelhof/P4-Genepool/blob/main/media/media-for-readme/staff-nav-bar.PNG)
  ...
  - When a user selects a navigation link , its clearly underlined to show users which navigation link is currently selected and what page they are currently viewing.

  - The navigation bar follows the same style as the footer using both bold white text with simple graphics to clarify what the function of each footer link does, and appears in the same format on all pages - this allows for consistency throughout the site.
  ...
  - This homepage landing section consists of a suttle hero image (which is my company's logo) over a blue background followed by white text below immediatly stating my company's mission and function , both elements are white to immediatly grab the attention of users and provide absolute contrast compaired to the blue background. 
  ...
  - Below the black heading text is 6 gray bootstrap cards with a simple heading and a "Find Out More" Button in each , the cards have a light grey background in order to provide visual clarity to the white background , as well as to provide contrast to the black text card titles used in each. 

  - The buttons in each card have a blue border with white text , both done intentially for contrast against the grey card background , for users using a PC or laptop , when the user hovers over a specific card , the entire card gets a blue background in order to show users that they are about to select a certain card , this is also the case when a user hovers over a cards button specifically. 

  - All card buttons will direct users to the products and services page , and will specifically focus on a selected category of service on the newly rendered page.
